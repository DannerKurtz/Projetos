<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReserveQuarto02.aspx.cs" Inherits="Pim_0_1.ReserveQuarrto02" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="conteudo">
	        <div id="body">
		        <h1><span>Quarto com vista para a cidade</span></h1>
		        <div>
			        <ul>
				        <li>
					        <a class="figure">
						        <img src="images/Quarto-Reserva-02.png"/>
					        </a>
					        <div>
                                <br />
						        <h3></h3>
